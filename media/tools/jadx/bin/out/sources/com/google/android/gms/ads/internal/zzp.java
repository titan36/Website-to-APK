...
public class zzp {
    ...
    static zzid zza(@Nullable final zzke zzke, @Nullable final zzkf zzkf, final zza zza) {
        return new zzid() {
    ...
    public static void zza(@Nullable zzpb zzpb, zza zza) {
        zzkf zzkf = null;
    ...
    private static boolean zzb(zzqw zzqw, zzjv zzjv, CountDownLatch countDownLatch) throws RemoteException {
        ...
        if (str2 != null) {
            zzqw.loadDataWithBaseURL(str2, str, "text/html", "UTF-8", null);
        } else {
