...
public class zzp extends FrameLayout implements OnClickListener {
    ...
    public zzp(Context context, zza zza2, zzv zzv) {
        ...
        addView(this.zzOi, new LayoutParams(zzel.zzeT().zzb(context, zza2.size + zza2.paddingLeft + zza2.paddingRight), zzel.zzeT().zzb(context, zza2.size + 0 + zza2.paddingBottom), 17));
    }
