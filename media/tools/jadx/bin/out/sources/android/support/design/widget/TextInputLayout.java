...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mPasswordToggleEnabled = a.getBoolean(R.styleable.TextInputLayout_passwordToggleEnabled, true);
    ...
    private void setEditText(EditText editText) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextGravity((8388615 & editTextGravity) | 48);
