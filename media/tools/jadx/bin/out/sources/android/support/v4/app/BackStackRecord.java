    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        if (sharedElementTransition != null) {
            ...
            if (namedViews.isEmpty()) {
                ...
                if (callback != null) {
                    ArrayList arrayList = new ArrayList(namedViews.keySet());
                    ArrayList arrayList2 = new ArrayList(namedViews.values());
                    callback.onSharedElementStart(arrayList, arrayList2, null);
                }
        ...
        AnonymousClass1 r0 = new ViewRetriever() {
            public View getView() {
        ...
        if (transition != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, exitTransition2, sceneRoot, r0, state.nonExistentView, state.enteringEpicenterView, state.nameOverrides, enteringViews, exitingViews, namedViews, renamedViews, sharedElementTargets);
