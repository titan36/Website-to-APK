...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        /*
            ...
            r11 = 0
            r10 = 0
            int r8 = android.support.v4.view.MotionEventCompat.getActionMasked(r15)
        ...
        if (ViewCompat.isLaidOut(child)) {
            ...
            if (!rect.isEmpty()) {
                ...
                if ((absDodgeInsetEdges & 80) == 80) {
                    int distance2 = ((getHeight() - rect.bottom) - lp.bottomMargin) + lp.mInsetOffsetY;
                ...
                if ((absDodgeInsetEdges & 3) == 3) {
                    int distance3 = (rect.left - lp.leftMargin) - lp.mInsetOffsetX;
                ...
                if ((absDodgeInsetEdges & 5) == 5) {
                    int distance4 = ((getWidth() - rect.right) - lp.rightMargin) + lp.mInsetOffsetX;
