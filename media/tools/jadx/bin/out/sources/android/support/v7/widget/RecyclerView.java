...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public final class Recycler {
        ...
        /* access modifiers changed from: 0000 */
        public boolean isPrefetchPositionAttached(int position) {
        ...
        /* access modifiers changed from: 0000 */
        public void prefetch(int[] itemPrefetchArray, int viewCount) {
            if (viewCount != 0) {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (!canRunFocusFailure || !(direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                if (ff.findNextFocus(this, focused, direction == 2 ? TransportMediator.KEYCODE_MEDIA_RECORD : 33) == null) {
            ...
            if (!needsFocusFailureLayout && this.mLayout.canScrollHorizontally()) {
                ...
                if (ff.findNextFocus(this, focused, z ^ rtl ? 66 : 17) == null) {
                    needsFocusFailureLayout = true;
                } else {
                    needsFocusFailureLayout = false;
                }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:80:0x036f, code lost:
        if (fling((int) r15, (int) r17) == false) goto L_0x0371;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
