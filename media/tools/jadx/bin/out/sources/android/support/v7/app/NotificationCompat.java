...
public class NotificationCompat extends android.support.v4.app.NotificationCompat {
    ...
    public static void addStyleToBuilderApi24(NotificationBuilderWithBuilderAccessor builder, android.support.v4.app.NotificationCompat.Builder b) {
    ...
    /* access modifiers changed from: private */
    public static RemoteViews addStyleGetContentViewLollipop(NotificationBuilderWithBuilderAccessor builder, android.support.v4.app.NotificationCompat.Builder b) {
    ...
    /* access modifiers changed from: private */
    public static RemoteViews addStyleGetContentViewJellybean(NotificationBuilderWithBuilderAccessor builder, android.support.v4.app.NotificationCompat.Builder b) {
    ...
    /* access modifiers changed from: private */
    public static CharSequence makeMessageLine(android.support.v4.app.NotificationCompat.Builder b, MessagingStyle style, Message m) {
    ...
    /* access modifiers changed from: private */
    public static RemoteViews addStyleGetContentViewIcs(NotificationBuilderWithBuilderAccessor builder, android.support.v4.app.NotificationCompat.Builder b) {
        if (b.mStyle instanceof MediaStyle) {
            MediaStyle mediaStyle = (MediaStyle) b.mStyle;
    ...
    /* access modifiers changed from: private */
    public static void addBigStyleToBuilderJellybean(Notification n, android.support.v4.app.NotificationCompat.Builder b) {
    ...
    private static void addDecoratedBigStyleToBuilder(Notification n, android.support.v4.app.NotificationCompat.Builder b) {
    ...
    private static void addDecoratedHeadsUpToBuilder(Notification n, android.support.v4.app.NotificationCompat.Builder b) {
    ...
    /* access modifiers changed from: private */
    public static void addBigStyleToBuilderLollipop(Notification n, android.support.v4.app.NotificationCompat.Builder b) {
        RemoteViews innerView;
        if (b.getBigContentView() != null) {
            innerView = b.getBigContentView();
        } else {
    ...
    /* access modifiers changed from: private */
    public static void addHeadsUpToBuilderLollipop(Notification n, android.support.v4.app.NotificationCompat.Builder b) {
        RemoteViews innerView;
