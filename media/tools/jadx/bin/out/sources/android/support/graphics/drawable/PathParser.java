...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        PathDataNode(char type2, float[] params2) {
            this.type = type2;
            this.params = params2;
        }
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            for (int i = 0; i < numSegments; i++) {
                ...
                p.rCubicTo(((float) (e1x + (alpha * ep1x))) - ((float) e1x), ((float) (e1y + (alpha * ep1y))) - ((float) e1y), ((float) (e2x - (alpha * ep2x))) - ((float) e1x), ((float) (e2y - (alpha * ep2y))) - ((float) e1y), ((float) e2x) - ((float) e1x), ((float) e2y) - ((float) e1y));
                eta1 = eta2;
                e1x = e2x;
                e1y = e2y;
                ep1x = ep2x;
