        ...
        if (enterTransitionObject != null || sharedElementTransitionObject != null) {
            ...
            container.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    FragmentTransitionCompat21.excludeViews(exitTransition, enterTransition, arrayList, true);
                    return true;
                }
            });
            ...
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    if (enterTransition != null) {
                        ...
                        FragmentTransitionCompat21.excludeViews(enterTransition, exitTransition, arrayList2, false);
                        FragmentTransitionCompat21.excludeViews(enterTransition, sharedElementTransition, arrayList3, false);
                    }
                    if (exitTransition != null) {
                        FragmentTransitionCompat21.removeTargets(exitTransition, arrayList2);
                        FragmentTransitionCompat21.excludeViews(exitTransition, enterTransition, arrayList, false);
                        FragmentTransitionCompat21.excludeViews(exitTransition, sharedElementTransition, arrayList3, false);
                    }
                    if (sharedElementTransition != null) {
