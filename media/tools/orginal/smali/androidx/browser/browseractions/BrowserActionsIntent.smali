...
.method static launchIntent(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    ...
    .line 330
    .local v3, "defaultHandler":Landroid/content/pm/ResolveInfo;
    if-eqz v3, :cond_3
    ...
    .end local v3    # "defaultHandler":Landroid/content/pm/ResolveInfo;
    .end local v4    # "defaultPackageName":Ljava/lang/String;
    :cond_3
    :goto_1
    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Landroid/support/v4/content/ContextCompat;->startActivity(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;)V
