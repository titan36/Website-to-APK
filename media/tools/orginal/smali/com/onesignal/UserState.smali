...
.method private modifySyncValuesJsonArray(Ljava/lang/String;)V
    ...
    .line 206
    .local v0, "orgArray":Lorg/json/JSONArray;
    :goto_0
    ...
    .line 210
    .local v2, "remArrayStr":Ljava/lang/String;
    move v4, v3
    ...
    .line 213
    .end local v2    # "remArrayStr":Ljava/lang/String;
    .end local v4    # "i":I
    :cond_2
    goto :goto_2
    ...
    .line 226
    .end local v0    # "orgArray":Lorg/json/JSONArray;
    .end local v1    # "tempArray":Lorg/json/JSONArray;
    goto :goto_4
...
.method generateJsonDiff(Lcom/onesignal/UserState;Z)Lorg/json/JSONObject;
    ...
    .line 115
    .local v0, "includeFields":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    invoke-static {v1, v2, v3, v0}, Lcom/onesignal/UserState;->generateJsonDiff(Lorg/json/JSONObject;Lorg/json/JSONObject;Lorg/json/JSONObject;Ljava/util/Set;)Lorg/json/JSONObject;

    move-result-object v1

    .line 117
    .local v1, "sendJson":Lorg/json/JSONObject;
    if-nez p2, :cond_0
