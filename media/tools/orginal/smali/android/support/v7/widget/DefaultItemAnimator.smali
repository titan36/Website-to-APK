...
.method public runPendingAnimations()V
    ...
    .line 103
    .local v1, "removalsPending":Z
    iget-object v2, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mPendingMoves:Ljava/util/ArrayList;
    ...
    .line 104
    .local v2, "movesPending":Z
    iget-object v3, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mPendingChanges:Ljava/util/ArrayList;
    ...
    .line 111
    :cond_0
    iget-object v5, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mPendingRemovals:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v6}, Landroid/support/v7/widget/DefaultItemAnimator;->animateRemoveImpl(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mPendingMoves:Ljava/util/ArrayList;

    invoke-virtual {v6, v7}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    .line 119
    iget-object v7, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mMovesList:Ljava/util/ArrayList;
    ...
    .line 121
    new-instance v7, Landroid/support/v7/widget/DefaultItemAnimator$1;

    invoke-direct {v7, v0, v6}, Landroid/support/v7/widget/DefaultItemAnimator$1;-><init>(Landroid/support/v7/widget/DefaultItemAnimator;Ljava/util/ArrayList;)V

    .line 132
    .local v7, "mover":Ljava/lang/Runnable;
    if-eqz v1, :cond_2
    ...
    iget-object v8, v8, Landroid/support/v7/widget/DefaultItemAnimator$MoveInfo;->holder:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v8, v7, v9, v10}, Landroid/support/v4/view/ViewCompat;->postOnAnimationDelayed(Landroid/view/View;Ljava/lang/Runnable;J)V
    ...
    .end local v7    # "mover":Ljava/lang/Runnable;
    :cond_3
    :goto_1
    if-eqz v3, :cond_5
    ...
    .line 142
    .local v6, "changes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/DefaultItemAnimator$ChangeInfo;>;"
    iget-object v7, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mPendingChanges:Ljava/util/ArrayList;

    invoke-virtual {v6, v7}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    .line 143
    iget-object v7, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mChangesList:Ljava/util/ArrayList;
    ...
    invoke-direct {v7, v0, v6}, Landroid/support/v7/widget/DefaultItemAnimator$2;-><init>(Landroid/support/v7/widget/DefaultItemAnimator;Ljava/util/ArrayList;)V
    ...
    invoke-static {v9, v7, v10, v11}, Landroid/support/v4/view/ViewCompat;->postOnAnimationDelayed(Landroid/view/View;Ljava/lang/Runnable;J)V
    ...
    .line 163
    .end local v6    # "changes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/DefaultItemAnimator$ChangeInfo;>;"
    ...
    .line 165
    .local v6, "additions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$ViewHolder;>;"
    iget-object v7, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mPendingAdditions:Ljava/util/ArrayList;

    invoke-virtual {v6, v7}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    .line 166
    iget-object v7, v0, Landroid/support/v7/widget/DefaultItemAnimator;->mAdditionsList:Ljava/util/ArrayList;
    ...
    .line 168
    new-instance v7, Landroid/support/v7/widget/DefaultItemAnimator$3;

    invoke-direct {v7, v0, v6}, Landroid/support/v7/widget/DefaultItemAnimator$3;-><init>(Landroid/support/v7/widget/DefaultItemAnimator;Ljava/util/ArrayList;)V

    .line 178
    .local v7, "adder":Ljava/lang/Runnable;
    if-nez v1, :cond_7
    ...
    .line 189
    .end local v6    # "additions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$ViewHolder;>;"
    .end local v7    # "adder":Ljava/lang/Runnable;
    move/from16 v16, v1

    goto :goto_6

    .line 179
    .restart local v6    # "additions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$ViewHolder;>;"
    .restart local v7    # "adder":Ljava/lang/Runnable;
    :cond_7
    :goto_3
    ...
    .line 183
    .end local v1    # "removalsPending":Z
    .local v0, "totalDelay":J
    .local v16, "removalsPending":Z
    invoke-virtual {v6, v5}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;
    ...
    invoke-static {v5, v7, v0, v1}, Landroid/support/v4/view/ViewCompat;->postOnAnimationDelayed(Landroid/view/View;Ljava/lang/Runnable;J)V

    .line 185
    .end local v0    # "totalDelay":J
    .end local v5    # "view":Landroid/view/View;
    .end local v8    # "changeDuration":J
    .end local v10    # "removeDuration":J
    .end local v12    # "moveDuration":J
    goto :goto_6

    .line 189
    .end local v6    # "additions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/support/v7/widget/RecyclerView$ViewHolder;>;"
    .end local v7    # "adder":Ljava/lang/Runnable;
    .end local v16    # "removalsPending":Z
    .restart local v1    # "removalsPending":Z
    :cond_b
    move/from16 v16, v1

    .line 189
    .end local v1    # "removalsPending":Z
    .restart local v16    # "removalsPending":Z
    :goto_6
    return-void
.end method
