.class public Lmurait/the/android/mania/HomeActivity;
...
.method public constructor <init>()V
    ...
    .line 33
    iput-object p0, p0, Lmurait/the/android/mania/HomeActivity;->mContext:Landroid/app/Activity;

    .line 35
    const-string v0, "https://www.websiteurl.com"

    iput-object v0, p0, Lmurait/the/android/mania/HomeActivity;->url:Ljava/lang/String;

    .line 37
    const-string v0, ""

    iput-object v0, p0, Lmurait/the/android/mania/HomeActivity;->currentUrl:Ljava/lang/String;

    return-void
.end method

.method static synthetic access$000(Lmurait/the/android/mania/HomeActivity;)Landroid/app/Activity;
    .locals 1
    .param p0, "x0"    # Lmurait/the/android/mania/HomeActivity;

    .line 29
    iget-object v0, p0, Lmurait/the/android/mania/HomeActivity;->mContext:Landroid/app/Activity;

    return-object v0
.end method

.method static synthetic access$102(Lmurait/the/android/mania/HomeActivity;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .param p0, "x0"    # Lmurait/the/android/mania/HomeActivity;
    .param p1, "x1"    # Ljava/lang/String;

    .line 29
    iput-object p1, p0, Lmurait/the/android/mania/HomeActivity;->currentUrl:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic access$200(Lmurait/the/android/mania/HomeActivity;)Landroid/view/View;
    .locals 1
    .param p0, "x0"    # Lmurait/the/android/mania/HomeActivity;

    .line 29
    iget-object v0, p0, Lmurait/the/android/mania/HomeActivity;->llError:Landroid/view/View;

    return-object v0
.end method

.method static synthetic access$300(Lmurait/the/android/mania/HomeActivity;)Landroid/webkit/WebView;
    .locals 1
    .param p0, "x0"    # Lmurait/the/android/mania/HomeActivity;

    .line 29
    iget-object v0, p0, Lmurait/the/android/mania/HomeActivity;->webView:Landroid/webkit/WebView;
...
.method private startWebView(Ljava/lang/String;)V
    ...
    new-instance v1, Lmurait/the/android/mania/HomeActivity$2;

    invoke-direct {v1, p0}, Lmurait/the/android/mania/HomeActivity$2;-><init>(Lmurait/the/android/mania/HomeActivity;)V
...
.method protected isOnline()Z
    ...
    invoke-virtual {p0, v0}, Lmurait/the/android/mania/HomeActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public onBackPressed()V
    ...
    invoke-virtual {p0, v0}, Lmurait/the/android/mania/HomeActivity;->findViewById(I)Landroid/view/View;
    ...
    .line 88
    :cond_0
    iget-object v1, p0, Lmurait/the/android/mania/HomeActivity;->webView:Landroid/webkit/WebView;
    ...
    .line 89
    invoke-virtual {p0}, Lmurait/the/android/mania/HomeActivity;->isOnline()Z
    ...
    .line 90
    iget-object v1, p0, Lmurait/the/android/mania/HomeActivity;->llError:Landroid/view/View;
    ...
    .line 96
    iget-object v1, p0, Lmurait/the/android/mania/HomeActivity;->progressDialog:Landroid/app/ProgressDialog;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lmurait/the/android/mania/HomeActivity;->setContentView(I)V
    ...
    invoke-virtual {p0, v0}, Lmurait/the/android/mania/HomeActivity;->setSupportActionBar(Landroid/support/v7/widget/Toolbar;)V

    .line 46
    const v1, 0x7f08006d

    invoke-virtual {p0, v1}, Lmurait/the/android/mania/HomeActivity;->findViewById(I)Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, Lmurait/the/android/mania/HomeActivity;->llError:Landroid/view/View;
    ...
    new-instance v1, Lmurait/the/android/mania/HomeActivity$1;

    invoke-direct {v1, p0}, Lmurait/the/android/mania/HomeActivity$1;-><init>(Lmurait/the/android/mania/HomeActivity;)V
    ...
    invoke-virtual {p0, v2}, Lmurait/the/android/mania/HomeActivity;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v3}, Lmurait/the/android/mania/HomeActivity;->findViewById(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Landroid/webkit/WebView;

    iput-object v3, p0, Lmurait/the/android/mania/HomeActivity;->webView:Landroid/webkit/WebView;
    ...
    .line 70
    iget-object v3, p0, Lmurait/the/android/mania/HomeActivity;->llError:Landroid/view/View;

    invoke-virtual {v3, v5}, Landroid/view/View;->setVisibility(I)V

    .line 71
    iget-object v3, p0, Lmurait/the/android/mania/HomeActivity;->webView:Landroid/webkit/WebView;

    invoke-virtual {v3, v4}, Landroid/webkit/WebView;->setVisibility(I)V

    .line 72
    iget-object v3, p0, Lmurait/the/android/mania/HomeActivity;->url:Ljava/lang/String;

    invoke-direct {p0, v3}, Lmurait/the/android/mania/HomeActivity;->startWebView(Ljava/lang/String;)V
    ...
    .line 76
    iget-object v3, p0, Lmurait/the/android/mania/HomeActivity;->progressDialog:Landroid/app/ProgressDialog;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    .line 107
    invoke-virtual {p0}, Lmurait/the/android/mania/HomeActivity;->getMenuInflater()Landroid/view/MenuInflater;
...
.method public onNavigationItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 155
    iget-object v2, p0, Lmurait/the/android/mania/HomeActivity;->url:Ljava/lang/String;

    invoke-direct {p0, v2}, Lmurait/the/android/mania/HomeActivity;->startWebView(Ljava/lang/String;)V
    ...
    .line 158
    iget-object v2, p0, Lmurait/the/android/mania/HomeActivity;->webView:Landroid/webkit/WebView;

    invoke-virtual {v2, v4}, Landroid/webkit/WebView;->setVisibility(I)V

    .line 159
    iget-object v2, p0, Lmurait/the/android/mania/HomeActivity;->progressDialog:Landroid/app/ProgressDialog;
    ...
    iget-object v3, p0, Lmurait/the/android/mania/HomeActivity;->mContext:Landroid/app/Activity;
    ...
    invoke-virtual {p0}, Lmurait/the/android/mania/HomeActivity;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v4}, Lmurait/the/android/mania/HomeActivity;->startActivity(Landroid/content/Intent;)V
    ...
    iget-object v4, p0, Lmurait/the/android/mania/HomeActivity;->webView:Landroid/webkit/WebView;
    ...
    .line 187
    invoke-virtual {p0}, Lmurait/the/android/mania/HomeActivity;->finish()V
    :try_end_0
    ...
    iget-object v6, p0, Lmurait/the/android/mania/HomeActivity;->mContext:Landroid/app/Activity;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    iget-object v5, p0, Lmurait/the/android/mania/HomeActivity;->mContext:Landroid/app/Activity;
    ...
    invoke-virtual {p0, v2}, Lmurait/the/android/mania/HomeActivity;->startActivity(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/content/ActivityNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
